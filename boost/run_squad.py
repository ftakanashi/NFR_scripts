      ...
      if "" not in seen_predictions:
        nbest.append(
            _NbestPrediction(
                ...
                end_logit=null_end_logit, start_index=0, end_index=0, prob=.0))
    # In very rare edge cases we could have no valid predictions. So we
    # just create a nonce prediction in this case to avoid failure.
    if not nbest:
      nbest.append(
          _NbestPrediction(text="empty", start_logit=0.0, end_logit=0.0, start_index=-1, end_index=-1, prob=.0))
